...
\newcommand{\acknowledgements}{
    ...
    \begin{column}{.6\textwidth}
        \begin{center}
            \includegraphics[width=\textwidth]{/Users/dasirianni/Documents/Presentations/media/group_photos/group_summer2016.jpg}
        \end{center}
    \end{column}
    \begin{column}{0.4\textwidth}
        \begin{center}
            ...
            \vspace{0.25cm}
            \includegraphics[width=.6\textwidth]{/Users/dasirianni/Documents/Presentations/media/logos/CDSgroup/logo_sherrillgroup_trans.png}
            \vspace{0.25cm}
            %\includegraphics[width=\textwidth]{/Users/dasirianni/Documents/Presentations/logos/funding/logo_nsf_trans.pdf}
            %\vspace{0.25cm}
            \includegraphics[width=.6\textwidth]{/Users/dasirianni/Documents/Presentations/media/logos/GaTech/gt_logos/Georgia-Tech.pdf}
        \end{center}
    \end{column}
    \end{columns}
    \vfill
    \begin{center}
    \includegraphics[width=0.9\textwidth]{/Users/dasirianni/Documents/Presentations/media/logos/funding/bms.jpg}
    \end{center}
