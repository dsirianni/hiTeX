...
% UR-Themed Title Frame
\newcommand{\URtitleframe}{
    {%
        \usebackgroundtemplate{%
            \includegraphics[width=\paperwidth]{/Users/dasirianni/Gits/hiTeX/beamer/themes/media/ur_titlebg.pdf}
        }
            {
            \renewcommand*{\insertshortinstitute}{}
            \renewcommand*{\insertshorttitle}{}
            \renewcommand*{\insertshortauthor}{}
            \renewcommand*{\insertdate}{}
